...
export class AppIconComponent {
  ...
  private iconPaths: { [key: string]: string } = {
    ...
    'FileUp': '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M12 12v6"></path><path d="m15 15-3-3-3 3"></path>',
    'Filter': '<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon>',
    'Flower2': '<path d="M12 5a3 3 0 1 1 3 3m-3-3a3 3 0 1 0-3 3m3-3v1m0 12a3 3 0 1 0 3-3m-3 3a3 3 0 1 1-3-3m3 3v-1m-7-7a3 3 0 1 1 3-3m-3 3a3 3 0 1 0 3 3m-3-3h1m12 0a3 3 0 1 0-3-3m3 3a3 3 0 1 1-3 3m3-3h-1"></path><circle cx="12" cy="12" r="3"></circle>',
    ...
    'GalleryVertical': '<path d="M3 2h18"></path><path d="M3 22h18"></path><rect width="18" height="12" x="3" y="6" rx="2"></rect>',
    ...
    'LayoutDashboard': '<rect width="7" height="9" x="3" y="3" rx="1"></rect><rect width="7" height="5" x="14" y="3" rx="1"></rect><rect width="7" height="9" x="14" y="11" rx="1"></rect><rect width="7" height="5" x="3" y="15" rx="1"></rect>',
    'Leaf': '<path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 3.5 1 9.22-1.24 5.13-1.24 5.13-7 8.78Z"></path><path d="M17 14c-4-1.53-4-5-4-5"></path><path d="M13.34 12.25 9 13"></path>',
    'LineChart': '<path d="M3 3v18h18"></path><path d="M19 9l-5 5-4-4-3 3"></path>',
    ...
    'ListOrdered': '<line x1="10" x2="21" y1="6" y2="6"></line><line x1="10" x2="21" y1="12" y2="12"></line><line x1="10" x2="21" y1="18" y2="18"></line><path d="M4 6h1v4"></path><path d="M4 10h2"></path><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"></path>',
    'Loader2': '<path d="M12 2v4"></path><path d="m16.2 7.8 2.9-2.9"></path><path d="M18 12h4"></path><path d="m16.2 16.2 2.9 2.9"></path><path d="M12 18v4"></path><path d="m7.8 16.2-2.9 2.9"></path><path d="M6 12H2"></path><path d="m7.8 7.8-2.9-2.9"></path>',
    ...
    'Package': '<path d="M16.5 9.4 7.5 4.21"></path><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line>',
    'PenLine': '<path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4 9.5-9.5z"></path>',
    ...
    'PlusCircle': '<circle cx="12" cy="12" r="10"></circle><path d="M8 12h8"></path><path d="M12 8v8"></path>',
    ...
    'Star': '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 6.86 14.14 1.82 9.27 8.91 8.26 12 2"></polygon>',
    'StarHalf': '<path d="M12 17.8 5.8 21 7.1 14.1 2 9.3l7-1L12 2"></path>',
    ...
    'Truck': '<rect width="16" height="13" x="2" y="4" rx="2"></rect><path d="M16 8h4l2 3v5"></path><line x1="10" y1="21" x2="10" y2="21"></line><circle cx="7" cy="21" r="2"></circle><circle cx="17" cy="21" r="2"></circle>',
    ...
    'Underline': '<path d="M6 3v7a6 6 0 0 0 6 6 6 6 0 0 0 6-6V3"></path><line x1="4" x2="20" y1="21" y2="21"></line>',

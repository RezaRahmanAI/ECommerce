...
export class AdminSettingsComponent implements OnInit {
  ...
  settingsForm = this.formBuilder.group({
    ...
    whatsAppNumber: [""],
    currency: ["BDT"],
    freeShippingThreshold: [5000, Validators.required],
    shippingCharge: [120, Validators.required],
    description: [""],
    facebookPixelId: [""],
    googleTagId: [""],
  ...
  ngOnInit(): void {
    this.settingsService.getSettings().subscribe((settings) => {
      ...
      this.settingsForm.patchValue({
        ...
        shippingCharge: settings.shippingCharge ?? 120,
  ...
  resetForm(): void {
    ...
    this.settingsForm.reset({
      ...
      freeShippingThreshold: this.lastSettings.freeShippingThreshold ?? 5000,
      shippingCharge: this.lastSettings.shippingCharge ?? 120,
